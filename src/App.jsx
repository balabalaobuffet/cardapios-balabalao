...
const PACKAGES_DATA = [
  ...
  },
  {
    ...
    groups: [
      { id: "salgados", name: "Salgados", icon: "utensils", sections: [
        { id: "s-fix", name: "6 salgados inclusos", type: "fixed", items: [...SALGADOS_FIXOS_5, { id: "mini-hotdog", name: "Mini hotdog" }] },
        { id: "s-choice", name: "Escolha mais 5 variedades", type: "choice", required: true,
          rule: { mode: "pick", min: 5, max: 5 }, options: [...SALGADOS_REG_OPTIONS] },
